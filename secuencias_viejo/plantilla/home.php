...
<li class="dropdown1 user user-menu"><a href="elegir_grupo.php">Grupo Actual:<BR><?php echo $_SESSION['nombre_asignacion'] ?></a></li>
              ...
              <li class="dropdown1 user user-menu"><a href="<?php echo $url_raiz ?>php/anio_lectivo.php">Año Lectivo</a></li>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo "../img/Avatars/".$_SESSION['img_avatar']?>" class="user-image" alt="User Image">
                  <?php } ?>
                  <span class="hidden-xs"><?php echo $_SESSION['nombre']." ".$_SESSION['apellido'] ?><br>
                  <?php echo nombre_grupo_asignacion($_SESSION['id_asignacion']) ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
