...
<p><b>Estimado Docente</b>, en esta sección usted deberá elegir un grupo para continuar navegando en esta aplicación, si desea cambiar de grupo, por favor diríjase a la opción Elegir Grupo del menú ubicado en la parte izquierda de la aplicación</p>
  <ul class="bs-glyphicons">
	...
	?>
	<li <?php if ($_SESSION['id_asignacion']==$row_av['id_asignacion']) echo 'style="background-color:#d6e6d6"'?>><span onclick="obtener_grupo(this);document.getElementById('form_avatar').submit();" data-id="<?php echo $row_av['id_asignacion'] ?>" ><?php echo $row_av['nombre'] ?></span></li>
	<?php
	}
	?>
    </ul> </div>
