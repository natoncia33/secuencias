...
<?php if ($reporte==""){ ?>
<th data-label="Nuevo" colspan="2"><form id="formNuevo" name="formNuevo" method="post" action="anio_lectivo.php">
...
<input title="Eliminar" type="image" src="<?php echo $url_raiz ?>img/eliminar.png" onClick="confirmeliminar('anio_lectivo.php',{'del':'<?php echo $row['id_anio_lectivo'];?>'},'<?php echo $row['id_anio_lectivo'];?>');" value="Eliminar">
</td>
<?php } ?>
</tr>
<?php 
...
<?php 
echo '<div class="form-group"><p><input title="" class="form-control" name="id_anio_lectivo" type="hidden" id="id_anio_lectivo" value="';if (isset($row['id_anio_lectivo'])) echo $row['id_anio_lectivo'];echo '"';echo '></p></div>';
echo '<div class="form-group"><p><label for="nombre_anio_lectivo">Año Lectivo:<span title="Este campo es obligatorio" style="color:red;font-size: 30px;margin: 2px;/top: 12px;top: 13px;position: relative;">*</span></label><input title="" class="form-control" name="nombre_anio_lectivo" type="text" id="nombre_anio_lectivo" value="';if (isset($row['nombre_anio_lectivo'])) echo $row['nombre_anio_lectivo'];echo '"';echo ' required ></p></div>';
echo '<div class="form-group"><p><input type="hidden" name="estado_anio_lectivo" value="Inactivo"><input title="" class="" name="estado_anio_lectivo" type="checkbox" id="estado_anio_lectivo" value="';echo 'Activo';echo '"';if (isset($row['estado_anio_lectivo']) and $row['estado_anio_lectivo']=="Activo") echo " checked ";echo '><label for="estado_anio_lectivo">Estado:</label></p></div>';
...
<div class="form-group"><p><label for="nombre_anio_lectivo">Año Lectivo<input title="" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_anio_lectivonombre_anio_lectivo',this.value);buscar();" onblur="this.onchange();" value="
...
"></label></p></div>
<div class="form-group"><p><label for="estado_anio_lectivo">Estado<input title="" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_anio_lectivoestado_anio_lectivo',this.value);buscar();" onblur="this.onchange();" value="
