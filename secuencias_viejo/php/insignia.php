...
if (move_uploaded_file($_FILES['foto_insignia']['tmp_name'],"../img/insignias/".$id_insignia.".".$ext))
...
?>
<span id="txtnombre_insigniaaciertos">g</span>
<?php
...
<div class="form-group"><p><label for="nombre_insignia">Nombre Insignia<input title="" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_insignianombre_insignia',this.value);buscar();" onblur="this.onchange();" value="
<?php if (isset($_COOKIE['busqueda_av_insignianombre_insignia'])) echo $_COOKIE['busqueda_av_insignianombre_insignia']; ?>
"></label></p></div>
<div class="form-group"><p><label for="foto_insignia">Foto Insignia<input title="" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_insigniafoto_insignia',this.value);buscar();" onblur="this.onchange();" value="
<?php if (isset($_COOKIE['busqueda_av_insigniafoto_insignia'])) echo $_COOKIE['busqueda_av_insigniafoto_insignia']; ?>
"></label></p></div>
<div class="form-group"><p><label for="aciertos">Aciertos<input title="" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_insigniaaciertos',this.value);buscar();" onblur="this.onchange();" value="
