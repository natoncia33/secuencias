...
<th>Imágen Avatar</th>
<?php if ($reporte==""){ ?>
<th colspan="2" class="thbotones"><form id="formNuevo" name="formNuevo" method="post" action="avatar.php">
...
<?php if (file_exists("../img/Avatars/".$row['img_avatar']) and $row['img_avatar'] != ""){ ?>
<div  style="background: url('../img/Avatars/<?php echo $row['img_avatar'] ?>');
