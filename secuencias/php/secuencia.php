...
<input type="image" src="<?php echo $url_raiz ?>img/eliminar.png" onClick="confirmeliminar('secuencia.php',{'del':'<?php echo $row['id_secuencia'];?>'},'N° <?php echo $row['id_secuencia']?>: <?php echo $row['nombre_secuencia'];?>');" value="Eliminar" title="Eliminar">
</p></div>
