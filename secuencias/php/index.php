...
if ($eliminar = $mysqli->query($sql)){
 ...
 ?>
<script>alert('Reto eliminado')</script>
...
$sql .= " GROUP BY asignacion.id_asignacion";
...
ventana_modal_nuevo_icono('id="form_guardar_icono" method="post" class="form_ajax" resp_1="Registro Exitoso" resp_0="Registro Fallido, Intente de nuevo" action="?guardar_elementos_juego" callback_1="document.getElementById(\'cerrar_modal_nuevo_icono\').click();document.getElementById(\'buscar_iconos\').onkeyup();" callback_0="false" callback="document.getElementById(\'buscar_iconos\').onkeyup();"');
...
<div id="slider">
  ...
  <output id="rangevalue">1</output>
    ...
    <input type="button" onclick="guardar_reto();" id="btn_crear" title="Crear" value="Crear"></p>
    </div>
    </span>
    </div>
</center>
