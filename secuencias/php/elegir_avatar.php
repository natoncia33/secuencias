...
Avatar: <img height="80" id="icon-img" src="<?php if (isset($_SESSION['img_avatar'])) echo $url_raiz."/img/Avatars/".$_SESSION['img_avatar']; ?>">
<span id="icono"></span>
<input type="hidden" id="icon" name="icon" value="<?php if (isset($row['img_avatar'])) echo "img/Avatars/".$row['img_avatar']; ?>"/>
...
if($row=$consulta->fetch_assoc()){
	...
	?>
	<li <?php if ($row['img_avatar']==$row_av['img_avatar']) echo 'style="background-color:#d6e6d6"'?>><span onclick="obtener_icono(this);document.getElementById('form_avatar').submit();" data-src="../img/Avatars/<?php echo $row_av['img_avatar'] ?>" data-id="<?php echo $row_av['id_avatar'] ?>" >
