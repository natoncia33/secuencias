...
<?php if ($reporte==""){ ?>
<th class="thbotones" data-label="Nuevo"><form id="formNuevo" name="formNuevo" method="post" action="grupo.php">
<input name="cod" type="hidden" id="cod" value="0">
<input type="image" name="submit" id="submit" value="Nuevo" title="Nuevo" src="<?php echo $url_raiz ?>img/nuevo.png">
</form>
</th>
<th class="thbotones" data-label="XLS"><form id="formNuevo" name="formNuevo" method="post" action="grupo.php?xls">
<input name="cod" type="hidden" id="cod" value="0">
<input type="image" title="Descargar en XLS" src="<?php echo $url_raiz ?>img/xls.png" name="submit" id="submit" value="XLS">
</form>
</th>
<?php } ?>
<th><form id="formNuevo" name="formNuevo" method="post" action="estadisticas.php">
<input name="cod" type="hidden" id="cod" value="">
<input type="image" title="Estadisticas" src="<?php echo $url_raiz ?>img/pie-chart.png" name="submit" id="submit" value="">
</form></th>
</tr>
</thead><tbody>
<?php 
...
<input title="Eliminar" type="image" src="<?php echo $url_raiz ?>img/eliminar.png" onClick="confirmeliminar('grupo.php',{'del':'<?php echo $row['id_grupo'];?>'},'<?php echo $row['nombre'];?>');" value="Eliminar">
</td>
<?php } ?>
<td>
 <form id="formNuevo" name="formNuevo" method="post" action="estadisticas.php" target="_blank">
<input name="cod" type="hidden" id="cod" value="<?php echo $row['id_grupo']; ?>">
<input type="image" title="Estadisticas" src="<?php echo $url_raiz ?>img/pie-chart.png" name="submit" id="submit">
</form>
</td>
</tr>
<?php 
...
<div class="form-group"><p><label for="nombre">Nombre<input placeholder="Nombre del grupo" title="Nombre del grupo" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_gruponombre',this.value);buscar();" onblur="this.onchange();" value="
