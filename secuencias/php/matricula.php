...
<p><input title="" class="form-control" name="id_matricula" type="hidden" id="id_matricula" value="<?php 
if (isset($row['id_matricula'])) echo $row['id_matricula'];
?>" ></p>
</div>
...
?><option value="<?php echo $row2['id_grupo']?>" <?php if (isset($row['grupo']) and $row['grupo'] == $row2['id_grupo']) echo " selected ";
...
?>
<select  title="" class="form-control" name="anio" id="anio" onchange="estudiantes_no_matriculados();" required>
<option value="">Seleccione una opci&oacute;n</option>
<?php
...
<div class="form-group"><p><label for="estudiante">Estudiante:<span title="Este campo es obligatorio" style="color:red;font-size: 30px;margin: 2px;/top: 12px;top: 13px;position: relative;">*</span></label>
<?php $estudiante = isset($row['estudiante']) ? $row['estudiante'] : ""; ?>
<span id="span_estudiante" pre="<?php echo $estudiante ?>">
<?php
estudiantes_no_matriculados($id_anio,$estudiante); ?>
</span>
</p>
</div>
<span id="txtanioestudiante">Disponible</span>
...
<div class="form-group"><p><label for="grupo">Grupo<input placeholder="Grupo" title="Grupo" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_matriculagrupo',this.value);buscar();" onblur="this.onchange();" value="
<?php if (isset($_COOKIE['busqueda_av_matriculagrupo'])) echo $_COOKIE['busqueda_av_matriculagrupo']; ?>
"></label></p></div>
<div class="form-group"><p><label for="anio">Año Lectivo<input placeholder="Año Lectivo" title="Año Lectivo" class="form-control input_busqueda_avanzada" type="number" onchange="grabarcookie('busqueda_av_matriculaanio',this.value);buscar();" onblur="this.onchange();" value="
<?php if (isset($_COOKIE['busqueda_av_matriculaanio'])) echo $_COOKIE['busqueda_av_matriculaanio']; ?>
"></label></p></div>
<div class="form-group"><p><label for="estudiante">Estudiante<input placeholder="Estudiante" title="Estudiante" class="form-control input_busqueda_avanzada" type="search" onchange="grabarcookie('busqueda_av_matriculaestudiante',this.value);buscar();" onblur="this.onchange();" value="
